...
def fibonacci_sequence(max_value):
    """
    Generates the Fibonacci sequence up to a given number using a while loop.

    Parameters:
    max_value (int): Maximum value for the Fibonacci sequence

    Returns:
    list: A list containing the Fibonacci sequence up to 'max_value'
    """

    # Handling edge cases: 0 and negative inputs
    if max_value <= 0:
        return []
