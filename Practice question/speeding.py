...
def speeding_ticket(speed, is_birthday):
    ...
    birthday_adjustment = 5 if is_birthday else 0
# Comparing speed with adjusted limits
    if speed <= 60 + birthday_adjustment:
        return "No Ticket"
    elif 61 <= speed <= 80 + birthday_adjustment:
        return "Small Ticket"
    else:
        return "Big Ticket"
...
print(speeding_ticket(85, True))   # should return "Small Ticket" # Your code goes here
